...
//import { ScrollView,Sc} from "react-native-gesture-handler";

export default function RutinaEspalda({navigation, route}) {
//    console.log("info",route.params)
    return (
        <ScrollView style={styles.container}>
           <View style={styles.imageContainer}>
                <View style={{alignItems: "center", justifyContent: "center" }}>
                    <Image
                    source={require("../../../../Imagenes/Jalon_Abierto.jpg")}
                    opacity={.3}
