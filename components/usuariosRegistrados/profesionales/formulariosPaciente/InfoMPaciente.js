        ...
        return(
            <TouchableOpacity style={styles.containerBUTTON} onPress={handleCargaAPI} >
                <LinearGradient
                    ...
                    style={styles.button}      
                >           
                    <Text style={styles.textBUTTON}>Cargar información</Text>
                </LinearGradient>
            </TouchableOpacity>
          );
    };
            ...
            return (
                <ScrollView style = {styles.container}>
                    <View style={styles.content}>
                        <Text style={styles.subtitle}>Datos para crear el expediente clinico</Text>
                        <Text style={styles.textoCampo}>Estatura : </Text>
                        <TextInput style={styles.input} value={datosAPICompleto.estatura.toString()} onChangeText={text => setEstatura(text)} keyboardType="numeric" />
                        <Text style={styles.textoCampo}>Ocupación : </Text>
                        <TextInput style={styles.input} value={datosAPICompleto.ocupacion} onChangeText={text => setOcupacion(text)} keyboardType="default" />
                        <Text style={styles.textoCampo}>IMC : </Text>
                        <TextInput style={styles.input} value={datosAPICompleto.imc.toString()} onChangeText={text => setImc(text)} keyboardType="numeric" />
                        <Text style={styles.textoCampo}>Objetivo : </Text>
                        <TextInput style={styles.input} value={datosAPICompleto.objetivo} onChangeText={text => setObjetivo(text)} keyboardType="default" />
                        <Text style={styles.textoCampo}>Alergias : </Text>
                        <TextInput style={styles.input} value={datosAPICompleto.alergias} onChangeText={text => setAlergias(text)} keyboardType="default" />
                        <Text style={styles.textoCampo}>Medicamentos : </Text>
                        <TextInput style={styles.input} value={datosAPICompleto.medicamentosC} onChangeText={text => setMedicamentos(text)} keyboardType="default" />
                        <Text style={styles.textoCampo}>Enfermedades que padece : </Text>
                        <Dropdown 
                            style={[styles.dropdown, isFocus && { borderColor: 'blue' }]}
                            placeholderStyle={styles.placeholderStyle}
